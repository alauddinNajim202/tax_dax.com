...
<div class="main-content tm-dashboard-home">
    ...
    <form class="custom-form profile-custom-form" action="">
        <div id="form-step-1">
            ...
            <div class="form-item mt-5">
                ...
                <div class="upload-profile-photo-container" id="uploadContainer">
                    ...
                    <div class="uploaded-profile-photo" id="uploadedPhotoContainer">
                        <img accept="image/*" class="uploaded-profile-photo-img" id="uploadedImage" src=""
            ...
            <div class="form-item">
                ...
                <input placeholder="Enter your Full Name" name="full-name" type="text">
            </div>
            <div class="form-item">
                <label for="">Business Name</label>
                <input placeholder="Enter your Business Name" name="business-name" type="text">
            </div>
            <div class="form-item">
                <label for="">Business Address</label>
                <input placeholder="Enter your Business Address" name="business-address" type="text">
            </div>
        ...
        <div id="form-step-2">
            ...
            <div class="form-item mt-5">
                ...
                <input placeholder="Ex: e.g., CPA, EA, Tax Attorney" name="full-name" type="text">
            </div>
            <div class="form-item">
        ...
        <div id="form-step-3">
            ...
            <div class="service-categories mb-5">
                ...
                <div class="service-categories-modal">
                    <div id="Personal Tax Preparation" class="item">Personal Tax Preparation</div>
                    <div id="Business Tax Preparation" class="item">Business Tax Preparation</div>
                    <div id="IRS Representation" class="item">IRS Representation</div>
                    <div id="Estate and Trust Taxes" class="item">Estate and Trust Taxes</div>
                    <div id="Tax Planning and Consulting" class="item">Tax Planning and Consulting</div>
                </div>
            </div>
            <div class="form-item">
            ...
            <div class="price-container mt-3 mt-md-5">
                <div>
                    ...
                    <div class="price-box">
                        $<input placeholder="0.000" value type="number" name="" id="" />/hr
                    </div>
                </div>
                <div>
                    <label for="">To</label>
            ...
            <div class=" mt-5">
                        ...
                        <div class="right">
                            ...
                            <div class="available-content">
                                <select>
                                    ...
                                    <option value="1-2">9.00 AM</option>
                                    <option value="1-2">9.00 AM</option>
                                    <option value="1-2">9.00 AM</option>
                                </select>
                                <select>
                                    <option selected disabled value="">To</option>
                                    <option value="1-2">5.00 PM</option>
                                    <option value="1-2">5.00 PM</option>
                                    <option value="1-2">5.00 PM</option>
                                </select>
                            </div>
                ...
                <div class="step-form-actions mt-5">
                    ...
                    <a class="next-btn">Save and Next</a>
                </div>
            </div>
    </form>
</div>
