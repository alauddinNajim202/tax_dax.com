                        ...
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-primary dash ms-auto box-shadow-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xml:space="preserve">
                                    ...
                                    <ellipse fill="#EDEFF1" cx="256" cy="356" rx="173.237" ry="100" />
                        ...
                        <div class="col col-auto top-icn dash">
                            <div class="counter-icon bg-secondary dash ms-auto box-shadow-secondary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        d="M21 16V8a2 2 0 0 0-1.11-1.79l-7-3.11a2 2 0 0 0-1.78 0l-7 3.11A2 2 0 0 0 3 8v8a2 2 0 0 0 1.11 1.79l7 3.11a2 2 0 0 0 1.78 0l7-3.11A2 2 0 0 0 21 16z" />
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ $totalReviewers ?? '' }}</h3>
                            <p class="text-muted fs-13 mb-0">Total Reviewers</p>
                        </div>
                        <div class="col col-auto top-icn dash">
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ $totalTransactions ?? '' }}</h3>
                            <p class="text-muted fs-13 mb-0">Total Transactions</p>
                        </div>
                        <div class="col col-auto top-icn dash">
