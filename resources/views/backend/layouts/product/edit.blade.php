        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card box-shadow-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category" id="category">
                                        ...
                                        <option value="stationary"
                                            {{ old('category', $product->category) == 'stationary' ? 'selected' : '' }}>
                                            Stationary</option>
                                        <option value="management"
                                            {{ old('category', $product->category) == 'management' ? 'selected' : '' }}>
                                            Management</option>
                                        <option value="service"
                                            {{ old('category', $product->category) == 'service' ? 'selected' : '' }}>
                                            service
                                        </option>
                                    </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control " name="price"
                                                ...
                                                value="{{ old('price', $product->productDetail->price) }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control " name="quantity"
                                                ...
                                                value="{{ old('price', $product->productDetail->quantity) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control " id="feature_details" name="feature_details" placeholder="...">{{ old('feature_details', $product->productDetail->feature_details) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control " id="product_details" name="product_details" placeholder="...">{{ old('product_details', $product->productDetail->product_details) }}</textarea>
                ...
                <div class="row row-deck">
                    ...
                    @foreach ($product->photoGalleries as $item)
                        <div class="col-xl-4 col-md-12">
                            <div class="card">
                                <form action="{{ route('product.gallery.destroy', $item) }}" method="POST"
                                    class="card-body delete-form">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" value="{{ $item->image }}" />
                                    <div class="d-flex flex-row-reverse bd-highlight mb-2">
                                        <button type="button" class="btn btn-danger delete-btn">
                                            <i class="ion-close-round" data-bs-toggle="tooltip" title=""
                                                data-bs-original-title="ion-close-round" aria-label="ion-close-round"></i>
                                        </button>
                                    </div>
            ...
            $('#submit').click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#images_error').text('');
                        if (response.success) {
                            // Show toaster success notification
